...
export interface ServerToClientEvents {
  ...
  'whiteboard:toggle':(s:WhiteboardState)=>void; 'whiteboard:draw':(d:{line:DrawLinePayload;senderId:string})=>void; 'whiteboard:stroke':(d:{stroke:DrawLinePayload[];senderId:string})=>void; 'whiteboard:strokeEnd':(d:{senderId:string})=>void;
